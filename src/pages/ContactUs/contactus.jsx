    ...
    return (
        <div className=' bg-white'>
            ...
            <div className='flex justify-center max-sm:flex-col p-10 max-sm:p-3'>
                ...
                <form action="" className=' bg-grey/1 py-8 px-16 max-sm:px-4 flex flex-col gap-5'>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <input className="p-2  border-none rounded-xl pb-40 " type="text" placeholder="Write your message here" id="user" />
                    </div>
