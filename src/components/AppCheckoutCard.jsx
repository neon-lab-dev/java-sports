  ...
  return (
    ...
    <div className='flex gap-4 max-sm:flex-col max-sm:justify-center'>
        ...
        <div className='flex flex-col gap-4 '>
            ...
            <button className="bg-red-500 text-lg p-1 text-white  max-lg:hidden rounded-[5px]"> Proceed to Pay</button>
        </div>
    </div>
    ...
    <button className="bg-red-500 text-lg p-1 text-white lg:hidden rounded-[5px]"> Proceed to Pay</button>
</div>
  )
}
