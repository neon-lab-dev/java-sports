...
import { items } from "./MockData/Ball";
                        ...
                        <div className='bg-white  absolute left-[-400px] top-[100px] border-2 xl:hidden p-5 duration-1500 translate-x-[400px]'>
                            <div className='font-Lato  border-2 p-3 absolute bg-white top-0 left-0'>
                                <div className='flex flex-col'>
                                    <div className='flex'>
                                        <span className=' pl-2 text-xl font-Lato font-700'>Shoe Type:</span>
                                    </div>
                                    <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                        ...
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                ...
                                                <label className={`${labelWrapper}`} htmlFor="Bags" id="Bags">Spikes</label>
                                            </div>
                                        </li>
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="red" id="" />
                                                <label htmlFor="Bags" className={`${labelWrapper}`} id="Bags">Rubber Studs</label>
                                            </div>
                                        </li>
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="red" id="" />
                                                <label htmlFor="Bags" className={`${labelWrapper}`} id="Bags">Turf Shoes</label>
                                            </div>
                                        </li>
                                    </ul>
                                    <div className='flex'>
                                    ...
                                    <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                        ...
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                ...
                                                <label htmlFor="size4" className={`${labelWrapper}`} id="Bags">UK 7</label>
                                            </div>
                                        </li>
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="red" id="size6" />
                                                <label htmlFor="size6" className={`${labelWrapper}`} id="Bags">UK 8</label>
                                            </div>
                                        </li>
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="black" id="" />
                                                <label htmlFor="Bags" className={`${labelWrapper}`} id="Bags">UK 9</label>
                                            </div>
                                        </li>
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="black" id="" />
                                                <label htmlFor="Bags" className={`${labelWrapper}`} id="Bags">UK 10</label>
                                            </div>
                                        </li>
                                    </ul>
                                    <div className='flex'>
