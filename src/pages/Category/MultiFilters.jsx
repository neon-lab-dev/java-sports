...
import AppCard1 from "@/components/reusable/AppCard1";
        ...
        <div className="bg-white">
            <div className='bg-white justify-center relative'>
                <div className=' p-3 bg-grey/1'>
                    <div className=''>
                        <span className=' pl-[9%] max-lg:pl-9 font-Lato text-[16px] font-700 align-middle'>Home {`>>`} Bats {`>>`} <span className='text-red-500'>All</span></span>
                    </div>
                </div>
            ...
            <div className="flex justify-center gap-4">
                ...
                <div className="flex">
                    <div className="bg-white grid grid-cols-4 gap-5 max-lg:grid-cols-2 justify-center">
