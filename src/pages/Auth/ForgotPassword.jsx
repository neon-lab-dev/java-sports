  ...
  return (
    ...
    <div className="flex flex-row  bg-white" style={{paddingLeft:"20vw", paddingBottom:"20px"}}>
      ...
      <form action="" className="flex flex-col p-10 bg-grey/1 gap-5">
        <h1 className=" text-4xl font-700">Forget Password</h1>
        ...
        <button className="bg-black text-white rounded-2xl p-2 mx-12">Send</button>
        <span className="text-center text-xs">Don't Recevied ?  <Link to="../signup" style={{ color: "red", textUnderlinePosition: "under" }}>send again.</Link></span>
      </form>
    </div>
    <AppFooter />
  </div>
