    ...
    return (
        <>
            <div className='flex flex-col'>
                <div className=''>
                    <div className='bg-white pl-[9%] max-sm:pl-[3%] max-lg:pl-[5%] flex flex-col gap-4 pt-6'>
                        <div>
                            <span className='font-700 font-Lato text-2xl'>Wishlist- 5 items</span>
                        </div>
                        <div className=' bg-white flex max-lg:justify-center'>
                            <div className="bg-white grid grid-cols-4 max-xl:grid-col-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-5 ">
                                <AppWishlistCard />
                                <AppWishlistCard />
                                <AppWishlistCard />
                                <AppWishlistCard />
