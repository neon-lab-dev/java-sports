            ...
            return (
                <form action="" className="flex flex-col gap-6 p-14 bg-grey/1 max-sm:mx-5 max-sm:p-8">
                    ...
                    <div className="flex flex-col gap-2">
                        <label htmlFor="otp" className="text-sm font-700 font-Lato ">Email or phone</label>
                        <input className="p-2 border-none rounded-xl" type="text" placeholder="Enter your email or phone" id="otp" />
                    </div>
