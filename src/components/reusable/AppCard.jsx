...
const AppCard = (props) => {
  const cardWrapper = `w-[250px] h-[400px] rounded-[20px] bg-neutral-white px-[22px] pt-[12px] pb-[20px] border my-[20px] m-4`;
  const imageWrapper = `bg-grey/1 w-[190px] h-[250px] rounded-[20px] my-4 flex justify-center items-center`
