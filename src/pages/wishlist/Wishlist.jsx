    ...
    return (
        <>
            <div className='flex flex-col'>
                <div className='bg-white pl-[10%] flex flex-col gap-4 pb-10'>
                    <div>
                ...
                <div className=' bg-white flex max-lg:justify-center py-6 px-4 pl-[10%] max-lg:pl-0'>
                    <div className="bg-white grid grid-cols-4 max-xl:grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-8">
                        <AppWishlistCard />
                        <AppWishlistCard />
                        <AppWishlistCard />
                        <AppWishlistCard />
